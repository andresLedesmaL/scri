...
# Save original directory so we can return to it (could also just use push,popd)

ORIG_DIR=$(pwd)

# Check to make su it doesn't already exist!
...
# Puts some content in the using echo and redirection.
